...
class Program
{
    ...
    {
        // Membuat Buat objek perpustakaan
        Perpustakaan perpustakaan = new Perpustakaan();

        // Buat beberapa objek
        Novel novel = new Novel("Midnight in December", 2024, "Kith");
        Komik komik = new Komik("Detektif Conan", 1994, "Gosho Aoyama");
        Majalah majalah = new Majalah("Ceria Anak", 2020, "edisi 9");
        MajalahAnak majalahAnak = new MajalahAnak("Bobo", 2020, "Edisi 10");
        ...
        perpustakaan.TambahItem(majalahTeknologi);
        Console.WriteLine();
